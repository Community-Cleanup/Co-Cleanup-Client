          ...
          <div>
            ...
            <p>
              <Span fs="18px">
                ...
                aliquid quasi, debitis voluptates odio asperiores voluptatem!
                Est praesentium quos, suscipit, impedit cumque, eius tenetur et
                sequi saepe aliquid rerum repellendus.
              </Span>
            </p>
            <div>
              <Button
              ...
              {!authState.data && (
                <Button w="130px" margin="32px 0 0" bg={theme.colors.buttonTwo}>
